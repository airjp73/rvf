...
A [prop-getter](https://kentcdodds.com/blog/how-to-give-rendering-control-to-users-with-prop-getters)
...
<PropHeader prop="formId" optional type="string" />

Allows you to connect to any form on the page,
even if the field isn't inside the form.
